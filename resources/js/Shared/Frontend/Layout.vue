    ...
    <div class="md:flex md:flex-col">
      <div class="md:flex md:flex-col md:h-screen">
        ...
        <div class="md:flex md:flex-grow md:overflow-hidden">
          <main-menu :menuItems="menuItems" class="hidden flex-shrink-0 p-12 w-56 bg-indigo-800 overflow-y-auto md:block" />
...
import MainMenu from '@/Shared/Frontend/MainMenu'
